    ...
    <div class="w-full ml-[16%] flex flex-col items-center pt-10 h-screen">
        <div class="w-6/12">
            <div class="flex gap-32">
                ...
                <div class="flex flex-col">
                    <div class="flex gap-8 items-center">
                        ...
                        <button class="btn btn-primary btn-sm" @click="handleFollow">{{ follower.includes(auth.currentUser?.uid as string) ? 'following' :
                            'follow' }}</button>
                    </div>
            ...
            <div class="grid grid-cols-3 gap-2">
                <div v-for="(post, index) in userPosts" :key="index" class="cursor-pointer" @click="openModal(post.postId)">
...
import { doc, getDoc, query, collection, onSnapshot, orderBy, where, setDoc, deleteDoc } from 'firebase/firestore';
...
export default {
    ...
    setup() {
        ...
        getFollow()
        return { modalStore, openModal, userInfo, userPosts, following, follower, auth, handleFollow }
    }
}
</script>