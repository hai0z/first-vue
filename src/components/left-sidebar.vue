<template>
    <div
        ...
        <img v-if="!noficationShow" class="object-cover w-28 self-start ml-4"
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/1280px-Instagram_logo.svg.png" alt="">
        <svg v-else aria-label="Instagram" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24"
            width="24">
        ...
        <div class="mt-8 space-y-3 w-full">
            ...
            <RouterLink class="flex gap-3 hover:bg-zinc-200 p-4 rounded-md" to="/profile">
                ...
                <span v-show="!noficationShow">{{ authStore.userInfo.displayName }}</span>
            </RouterLink>
